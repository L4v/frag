...
inline CubicBezier GetCubicBezier(ImVec2 start, ImVec2 end,
  ...
  assert((start_type == ImNodesAttributeType_Input) ||
...
ImVec2 GetScreenSpacePinCoordinates(const ImRect &node_rect,
  ...
  assert(type == ImNodesAttributeType_Input ||
...
void StyleColorsDark() {
  ...
  GImNodes->Style.Colors[ImNodesCol_MiniMapBackground] =
      IM_COL32(25, 25, 25, 150);
  GImNodes->Style.Colors[ImNodesCol_MiniMapBackgroundHovered] =
      IM_COL32(25, 25, 25, 200);
  GImNodes->Style.Colors[ImNodesCol_MiniMapOutline] =
      IM_COL32(150, 150, 150, 100);
  GImNodes->Style.Colors[ImNodesCol_MiniMapOutlineHovered] =
  ...
  GImNodes->Style.Colors[ImNodesCol_MiniMapNodeOutline] =
      IM_COL32(200, 200, 200, 100);
  GImNodes->Style.Colors[ImNodesCol_MiniMapLink] =
