...
Mesh::Vertex::Vertex(const r32 *position, const r32 *normal, const r32 *texCoords, const u32 *joints, const r32 *weights) {
...
Mesh::Mesh(const std::vector<Vertex> &vertices, const std::vector<u32> &indices) {
    ...
    glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, sizeof(Vertex), (void*)(offsetof(Vertex, mTexCoords)));
    glEnableVertexAttribArray(1);

    glVertexAttribPointer(2, 3, GL_FLOAT, GL_FALSE, sizeof(Vertex), (void*)(offsetof(Vertex, mNormal)));
    glEnableVertexAttribArray(2);

    glVertexAttribIPointer(3, 4, GL_INT, sizeof(Vertex), (void*) (offsetof(Vertex, mJointIds)));
...
void
Mesh::Draw(const ShaderProgram &program) {
